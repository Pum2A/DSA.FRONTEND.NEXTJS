...
function getModuleIcon(module: Module): JSX.Element {
  const lowerCaseId = String(module.externalId || module.id).toLowerCase();
  ...
  const defaultIcons = [
    <Code2 key="code" {...iconProps} />,
    <Package key="package" {...iconProps} />,
    <Component key="component" {...iconProps} />,
  ];
  const hashCode =
    module.id
      ?.toString()
